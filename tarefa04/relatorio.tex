...
\texttt{sqrt} e \texttt{sin} não são 1 FLOP cada. São funções de biblioteca com dezenas de operações internas, Newton-Raphson, polinômios minimax. A contagem de $\sim$1050 FLOPs é uma estimativa razoável do custo real em software.
