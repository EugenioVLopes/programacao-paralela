// gcc -std=c11 -O2 -Wall -Wextra -fopenmp v5_guided_collapse.c -lm -o ns_v5
#ifndef _OPENMP
...
int main(int argc, char **argv) {
    ...
    printf("%s tamanho_grid=%d num_passos_tempo=%d modo=%d threads=%d r=%.3f tempo=%.9f s minimo=%.17g pico=%.17g soma=%.17g\n",
           "v5_guided_collapse", tamanho_grid, num_passos_tempo, mode, threads, r, elapsed, minimum, peak, sum);
