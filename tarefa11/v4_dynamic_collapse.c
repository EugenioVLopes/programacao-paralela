// gcc -std=c11 -O2 -Wall -Wextra -fopenmp v4_dynamic_collapse.c -lm -o ns_v4
#ifndef _OPENMP
...
int main(int argc, char **argv) {
    ...
    printf("%s tamanho_grid=%d num_passos_tempo=%d modo=%d threads=%d r=%.3f tempo=%.9f s minimo=%.17g pico=%.17g soma=%.17g\n",
           "v4_dynamic_collapse", tamanho_grid, num_passos_tempo, mode, threads, r, elapsed, minimum, peak, sum);
